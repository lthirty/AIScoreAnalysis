...
export const BUILD_NUMBER = '20260517-2';
...
export const CHANGELOG = [
  {
    ...
    author: 'Codex',
    changes: [
      '升级为大版本 v5.0.0，继续保持 AI 深入分析结构化输出与针对性建议能力',
      '各科趋势深度分析默认收缩，增强分析调试信息也改为默认收缩，减少首屏干扰',
      '各科得分率表格新增变化趋势列，章节独立建议先给整体分析和整体建议，再给分项针对性建议',
      '缺少数据的科目也补充了更有价值的通用建议，并同步更新 CloudBase 后端部署包',
      '微信小程序版本号升级到 v5.0.0 · 2026-05-17'
    ]
  },
  {
    version: '3.0.23',
